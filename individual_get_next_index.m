function [curr_indexes,currx2,curry2] = individual_get_next_index(tot_weights,x,y,currx,curry,curr_indexes)
...
currx2(~isnan(curr_indexes)) = x(curr_indexes(~isnan(curr_indexes)));
curry2(~isnan(curr_indexes)) = y(curr_indexes(~isnan(curr_indexes)));